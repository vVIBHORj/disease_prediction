...
root = Tk()
from tkinter import StringVar, Label, Entry, OptionMenu, Button, Text
root.configure(background='#2E2E2E')  # Dark grey background
...
# Heading
w2 = Label(root, justify=CENTER, text="Predict your disease using ML", fg="#FDFEFE", bg="#2E2E2E")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="By:- Vibhor", fg="#FDFEFE", bg="#2E2E2E")
